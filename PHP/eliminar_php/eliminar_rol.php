...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
        ...
        if (isset($_GET['confirm']) && $_GET['confirm'] == 'true') {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                header("Location:../index_roles.php?mensaje=" . urlencode($mensaje));
            } else {
    ...
    ?>
            ...
            <div class="login-form">
                <h1 style="color:white;">Eliminar rol</h1>
                <p class="login-text">
                    <span class="fa-stack">
                ...
                ?>
                <p style="color:white;">¿Estás seguro de que deseas eliminar este Rol?</p>
